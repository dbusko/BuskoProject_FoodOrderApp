...
import com.android.foodorderapp.Models.Menu;
import com.android.foodorderapp.Models.RestaurantModel;
...
public class PlaceYourOrderActivity extends AppCompatActivity {
    ...
    private void calculateTotalAmount(RestaurantModel restaurantModel) {
        ...
        if(isDeliveryOn) {
            tvDeliveryChargeAmount.setText("₴"+String.format("%.2f", (restaurantModel.getDelivery_charge())*15));
            subTotalAmount += (restaurantModel.getDelivery_charge()*15);
        }
