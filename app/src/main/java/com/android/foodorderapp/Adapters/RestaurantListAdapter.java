...
public class RestaurantListAdapter extends RecyclerView.Adapter<RestaurantListAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RestaurantListAdapter.MyViewHolder holder, int position) {
        ...
        holder.restaurantAddress.setText("Адреса: "+restaurantModelList.get(position).getAddress());
        holder.restaurantHours.setText("Години роботи на сьогодні: " + restaurantModelList.get(position).getHours().getTodaysHours());
